    ...
    Activity 1:  Add your APIXU API KEY in the code below.  This KEY can be retreived by visiting the 
                 ...
                 (https://www.apixu.com)
                  ...
                  Use the following code as an example:  
                     ...
                     url: 'https://api.apixu.com/v1/forecast.json?key= 9fc32c267aaa46a99b6175545171112',
...
/******************************************************INSERT YOUR CODE BELOW!!!***********************************************/
        ...
        $(document).ready(function(){
           $(':button').click(function(){
                ...
                $.ajax({
                      type: 'GET',
                      url: 'https://api.apixu.com/v1/forecast.json?key=9fc32c267aaa46a99b6175545171112&q ',
                      data: message             
                })
                .done(function(json){
